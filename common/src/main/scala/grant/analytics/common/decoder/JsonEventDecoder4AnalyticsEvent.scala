...
import grant.analytics.common.event.alternative.{AnalyticsEvent, DefaultUserEventParserContainer}
...
class JsonEventDecoder4AnalyticsEvent (props: VerifiableProperties = null) extends scala.AnyRef with kafka.serializer.Decoder[AnalyticsEvent]{
  ...
  private lazy val event_parser_container = new DefaultUserEventParserContainer
